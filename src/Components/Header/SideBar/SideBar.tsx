                ...
                <ul className="mt-16">
                    {SideBarData.map((item, index) => (
                        <li key={index} className="py-4">
                            <Link to={item.path} onClick={toggleSidebar} className="lg:text-8xl md:text-7xl text-gray-700 font-bold font-mono flex flex-col items-center transition duration-300 hover:underline hover:text-gray-500 hover:scale-110 transition-all duration-500 cursor-pointer">
